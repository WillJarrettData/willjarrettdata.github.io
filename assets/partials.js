        ...
        <div class="hidden closed" id="hidden">
            <div class="hidden-inner">
                <div class="hidden-about">
                    ...
                    <p class="hidden-about-text">I moved back to London and joined <strong>Tortoise Media</strong> as a developer in 2024. Now, I am now working for the <strong>Associated Press</strong> as an Interactive Artist.</p>
                </div>
